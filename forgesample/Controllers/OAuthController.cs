  ...
  public class OAuthController : ApiController
  {
    ...
    public string GetOAuthURL()
    {
      ...
      string oauthUrl = _threeLeggedApi.Authorize(
        ...
        new Scope[] { Scope.DataRead, Scope.DataWrite /*Write required for webhook*/, Scope.ViewablesRead });
  ...
  public class Credentials
  {
    ...
    private async Task RefreshAsync()
    {
      ...
      dynamic credentialInternal = await oauth.RefreshtokenAsync(
        GetAppSetting("FORGE_CLIENT_ID"), GetAppSetting("FORGE_CLIENT_SECRET"),
        "refresh_token", RefreshToken, new Scope[] { Scope.DataRead, Scope.DataWrite /*Write required for webhook*/, Scope.ViewablesRead });
